...
API_DIR = Path(__file__).parent.resolve()   # .../document_portal/api
ROOT_DIR = API_DIR.parent                   # .../document_portal
STATIC_DIR = ROOT_DIR / "static"            # .../document_portal/static
TEMPLATES_DIR = ROOT_DIR / "templates"      # .../document_portal/templates
